...
\author[~]{Lorenzo~Moneta~(CERN)\and Markus~Stoye~(CERN)\and Michele~Floris~(CERN)\and Paul~Seyfert~(CERN)\and Sergei~Gleyzer~(University~of~Florida)\and Steven~Randolph~Schramm~(Université~de~Genève)}
\institute[CERN]{}
\date[\today]{}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item next EP-IT data science seminar by  Conor Fitzpatrick (EPFL)
      ...
      \newline  Wednesday 13 Dec 2017, 11:00
...
\begin{frame}
  ...
  \begin{itemize}
      \item plans getting more and more concret
